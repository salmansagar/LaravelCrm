<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-row md:flex-row items-center">
      ...
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        <a class="mr-5 hover:text-gray-900 mx-25">Home</a>
      ...
      <button class="inline-flex items-center bg-green-500 border-0 py-1 px-3 focus:outline-none hover:bg-green-200 text-gray-200 font-semibold rounded text-base mt-4 md:mt-0">Post new Ad
