                          ...
                          <div>
                              <div class="md:grid md:grid-cols-3 md:gap-6">
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                  ...
                                  <form class="row g-3" action="{{route('employees.index')}}" method="POST" enctype="multipart/form-data">
                                    @csrf

                                    <div class="col-8">
                                      <label for="firstname" class="form-label ml-5 "> First Name</label>
                                      <input type="text" name="firstname" class="form-control ml-5" id="name" placeholder="First name">
                                    </div>

                                    <div class="col-8">
                                        <label for="lastname" class="form-label ml-5 mt-2"> Last Name</label>
                                        <input type="text" name="lastname" class="form-control ml-5" id="name" placeholder="Last name">
                                      </div>
                                    <div class="col-8">
                                      <label for="email" class="form-label ml-5 mt-2">Email</label>
                                      <input type="email" name="email" class="form-control ml-5" id="name" placeholder="email">
                                    </div>
                                    <div class="col-8">
                                        <label for="Phone" class="form-label ml-5 mt-2">Phone</label>
                                        <input type="number" name="phone" class="form-control ml-5" min="0" maxlength="11" id="name" placeholder="Phone">
                                      </div>
